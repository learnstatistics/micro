...
\newlength{\logoleft}
\ifthenelse{\equal{\detokenize{print-cover}}{\jobname}\or\equal{\detokenize{solutions-print-cover}}{\jobname}}{
...
\begin{center*}
	\textbf{
		\fontsize{37}{36}\selectfont \textcolor{titletextcolour}{Principles of}\\
		\fontsize{45}{45}\selectfont \textcolor{titletextcolour}{\booksubject}\\ [.7\baselineskip]
...
\node at ([xshift=-16cm,yshift=-8cm]current page.east)
{
\begin{titlemainbox}
	\begin{center}
		\textcolor{white}{
			...
			\fontsize{28pt}{30pt}\selectfont{\textbf{YOUR MICROECONOMICS COURSE}}\\ [.9\baselineskip]
